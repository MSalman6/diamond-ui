...
export default function ProposalDetailsPage() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      // if voting stats available, their effect will update these; otherwise keep sample animation
    ...
    async function getProposalDetails(pid?: string) {
      ...
      try {
        ...
        if (daoContext.getProposalDetails) {
          // small delay to allow RPC to update if needed (keeps parity with original logic)
          setTimeout(() => {
        ...
        <div className="container">
          <div className="proposal-hero-content">
            ...
            <div className="proposal-header">
              <h1 id="proposal-title">{proposal?.title || 'Increase Min Delegate Fee'}</h1>
              <div className="proposal-meta">
                <div className="proposal-date">
                  <i className="fas fa-calendar" /> Date: {proposal?.timestamp ? timestampToDate(proposal.timestamp) : '4 Mar 2025'}
                </div>
          ...
          <div className="proposal-grid">
            <div className="proposal-info">
              ...
              <div className={`proposal-card funding-request-card ${type !== "funding-request" ? "hidden" : ""}`} id="funding-request-content">
                ...
                <div className="card-content">
                  <div className="funding-purpose"><h4>{proposal?.title || 'Community Development Fund Allocation Q2'}</h4></div>
              ...
              <div className={`proposal-card contract-upgrade-card ${type !== "contract-upgrade" ? "hidden" : ""}`} id="contract-upgrade-content">
                ...
                <div className="card-content">
                  <div className="upgrade-title"><h4>{proposal?.title || 'Staking Upgrade v2.6'}</h4></div>
                ...
                <div className="timeline">
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      <div className="timeline-date">4 Mar 2025, 10:23 UTC</div>
              ...
              <div className="related-proposals-section">
                ...
                <div className="related-proposal-item">
                  ...
                  <div className="related-proposal-content">
                    <div className="related-proposal-title">Validator Minimum Delegation Fee Increase</div>
